...
async function loadROMFromURL(url) {
    ...
    // Write the ROM to the virtual filesystem
    Module.FS.writeFile("/game.sfc", uint8Array);
    
    // Load the ROM into the emulator
    Module.ccall("loadROM", null, ["string"], ["/game.sfc"]);
}

// Use the RAW URL from GitHub (replace with your actual file's raw URL)
loadROMFromURL("https://raw.githubusercontent.com/Internetperson-dev/site/main/etc/240pSuite.sfc");
